variable backend_services {
  description = "List of maps, each defining a Backend Service to be created. The first Backend Service in the list is the default service applied to the generated URL Map. See https://registry.terraform.io/providers/hashicorp/google/latest/docs/resources/compute_backend_service."
  type = any
  # type = list(object({
